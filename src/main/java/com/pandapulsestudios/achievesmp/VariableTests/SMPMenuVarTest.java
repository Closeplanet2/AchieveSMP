...
@PulseAutoRegister
public class SMPMenuVarTest implements PulseVariableTest {
    @Override
    ...
    public boolean IsType(Object variable) {
        try{
            var test = SMPMenu.valueOf(variable.toString());
            return true;
    ...
    public Object DeSerializeData(Object serializedData) {
        return SMPMenu.valueOf(serializedData.toString());
    }
    ...
    @Override
    public Object ReturnDefaultValue() { return SMPMenu.HELP_MENU; }

    @Override
    public void CUSTOM_CAST_AND_PLACE(List<Object> toAdd, int place, List<?> castedData, Class<?> arrayType) {
        toAdd.add(castedData.toArray(new SMPMenu[0]));
    }
}
